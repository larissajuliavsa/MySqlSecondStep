...
INSERT INTO SpotifyClone.albums (album, artista_id, album_lancamento)
VALUES
  ('Envious', 1, 1990),
  ('Exuberant', 1, 1993),
...
INSERT INTO SpotifyClone.musicas (musica, musica_duracao, album_id, artista_id)
VALUES
  ('Soul For Us', 200, 1, 1),
  ...
  ('Words Of Her Life', 185, 5, 3),
  ('Without My Streets', 176, 5, 3),
...
INSERT INTO SpotifyClone.usuarios (usuario, plano_id, assinatura)
VALUES
  ('Thati', 1, '2019-10-20'),
  ('Cintia', 2, '2017-12-30'),
  ('Bill', 3, '2019-06-05'),
  ('Roger', 4, '2020-05-13'),
  ('Norman', 4, '2017-02-17'),
  ('Patrick', 2, '2017-01-06'),
  ('Vivian', 3, '2018-01-05'),
  ('Carol', 3, '2018-02-14'),
  ('Angelina', 2, '2018-04-29'),
  ('Paul', 2, '2017-01-17');

INSERT INTO SpotifyClone.historico (usuario_id, musica_id, data_historico)
VALUES
